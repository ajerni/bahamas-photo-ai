...
## Uploads / Handling:
- there will only ever be the existing trip_1 - which can be modified and extended:
    - uploading new photos
    - deleting single photos
    - deleting all photos
    - changing tests manually (currently under "refine" - make it possible on the details view of the single entries)


## Structure:
- think of a nice user experiance and redesign - its all about his one trip. We want to see Photos, Timeline, Map, Chat (not the old split into Read / Explore / Refine / Ask)
